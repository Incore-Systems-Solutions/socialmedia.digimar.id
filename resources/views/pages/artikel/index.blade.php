@extends('layouts.main')
   ...
   <!-- Meta Item -->
    ...
    <title>{{ $meta['meta'][$lang]['title'] ?? 'socialmedia.digimar.id - Satu Tempat untuk Semua Sosial Media Anda' }}</title>
    <meta name="description" content="{{ $meta['meta'][$lang]['description'] ?? 'Kelola, jadwalkan, dan analisa performa semua akun sosial media Anda dari satu dashboard terintegrasi bersama Digimar.' }}">
    <meta name="keywords" content="{{ $meta['meta'][$lang]['keywords'] ?? 'manajemen sosial media, jadwal posting, analisa media sosial, strategi konten, branding digital, dashboard sosial media, digimar sosial media' }}">
   <!-- Schema Item -->
    {{-- Schema Item --}}
